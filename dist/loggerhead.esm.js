  ...
  function DataMaskingUtils(config) {
    ...
    if (config && Array.isArray(config.rules)) {
      this.config = {
        ...
        rules: __spreadArrays(defaultConfig.rules, config.rules)
      };
    }

    if (config && config.enableDefaults) {
      this.config.enableDefaults = __assign(__assign({}, defaultConfig.enableDefaults), config.enableDefaults);
      defaultRules.forEach(function (defaultRule) {
        var enableRule = config.enableDefaults && config.enableDefaults[defaultRule.name];

        if (enableRule) {
          _this.config.rules = __spreadArrays(_this.config.rules, [defaultRule]);
        }
      });
    }
...
var Loggerhead = function () {
  ...
  Loggerhead.prototype.log = function (level) {
    ...
    if (this.loggingEnabled() && this.level >= level) {
      ...
      this.instance.apply(this, __spreadArrays(['%j'], args));
    }
  };
  ...
  Loggerhead.prototype.trace = function () {
    ...
    this.log.apply(this, __spreadArrays([LogLevels.TRACE], args));
  };
  ...
  Loggerhead.prototype.info = function () {
    ...
    this.log.apply(this, __spreadArrays([LogLevels.INFO], args));
  };
  ...
  Loggerhead.prototype.debug = function () {
    ...
    this.log.apply(this, __spreadArrays([LogLevels.DEBUG], args));
  };
  ...
  Loggerhead.prototype.warn = function () {
    ...
    this.log.apply(this, __spreadArrays([LogLevels.WARN], args));
  };
  ...
  Loggerhead.prototype.error = function () {
    ...
    this.log.apply(this, __spreadArrays([LogLevels.ERROR], args));
  };
  ...
  Loggerhead.prototype.fatal = function () {
    ...
    this.log.apply(this, __spreadArrays([LogLevels.FATAL], args));
  };
